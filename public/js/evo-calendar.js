...
;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    ...
                    es: {
                        ...
                        noEventForToday: "Hoy no tienes guardias",
                        noEventForThisDay: "No tienes guardias programadas para este día"
                    },
                    de: {
                    ...
                    tr: {
                        ...
                        daysMin: ["Pz", "Pa", "Sa", "Ça", "Pe", "Cu", "Ct"],
                        months: ["Oca", "Şubat", "Mart", "Nisan", "Mayıs", "Haziran", "Temmuz", "Ağustos", "Eylül", "Ekim", "Kasım", "Aralık"],
                        monthsShort: ["Oca", "Şub", "Mar", "Nis", "May", "Haz", "Tem", "Ağu", "Eyl", "Eki", "Kas", "Ara"],
                        noEventForToday: "Bugün için bir etkinlik yok. ",
                        noEventForThisDay: "Seçilen gün için bir etkinlik yok. Dinlenebilirsiniz :)"
                    },
                }
            }
            _.initials.weekends = {
    ...
    EvoCalendar.prototype.init = function(init) {
        ...
        if (!$(_.$elements.calendarEl).hasClass('calendar-initialized')) {
            $(_.$elements.calendarEl).addClass('evo-calendar calendar-initialized event-hide');
    ...
    EvoCalendar.prototype.buildTheBones = function() {
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            markup +=   '<div class="glosario">'+
                '<div class="event-list">'+
                '<div class="event-container event-container1" role="button" data-event-index="undefined">'+
                '<div class="event-icon">'+
                '<div class="event-bullet-insular"></div>'+
                '</div>'+
                '<div class="event-info"><p class="event-title arriba">INSULAR | 24H</p></div>'+
                '</div>'+
                '</div>'+
                ...
                '<div class="event-container event-container1" role="button" data-event-index="undefined">'+
                '<div class="event-icon">'+
                '<div class="event-bullet-refuerzo"></div>'+
                '</div>'+
                '<div class="event-info"><p class="event-title arriba">REFUERZO | 15H A 22H</p></div>'+
                '</div>'+
                '</div>'+
                ...
                '<div class="event-container event-container1" role="button" data-event-index="undefined">'+
                '<div class="event-icon">'+
                '<div class="event-bullet-materno"></div>'+
                '</div>'+
                '<div class="event-info"><p class="event-title arriba">MATERNO | 24H</p></div>'+
                '</div>'+
                '</div>'+
