...
Route::group(['middleware' => ['admin']], function () {
    ...
    Route::get('guardias.truncate', [App\Http\Controllers\GuardiaController::class,'truncate'])->name('guardias.truncate');
    Route::get('guardias-generate/{semestre}', [ GuardiaController::class, 'generateGuardia' ]);
});
